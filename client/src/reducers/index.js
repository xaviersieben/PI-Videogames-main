...
export function reducer (state= initialState, {type,payload}){
    switch(type){
        ...
        case "FILTER_BY_GENRE":
            ...
            const genreFiltered = payload === "Genres" ? allVideoGames : allVideoGames.filter(e => e.genres?.includes(payload))
            return{
                ...JSON.parse(JSON.stringify(state)),
        ...
        case "FILTER_BY_CREATED":
            ...
            const createdFilter = payload === "Created" ? allVideoGames2.filter(e => e.createInDb) : allVideoGames2.filter( e => !e.createInDb)
            return{
                ...JSON.parse(JSON.stringify(state)),
        ...
        case  "ORDER_BY_NAME":
            let sortGame = payload === "asc" || payload === "alpha"
        ...
        case "ORDER_BY_RATING":
            ...
            let sortByRating = payload === "Hight"
            ? state.videogames.sort((a,b)=>{
